...
@section('main')
    <div data-barba="container" x-data="{ sideBar: true }">
        <div class="sticky top-0 z-50 bg-white">
            <div class="flex items-center justify-between  lg:flex-row flex-col gap-4 px-8 py-2 pt-2 border-b">
                <div class="flex items-center justify-between gap-6 text-lg">
                    <div class="text-gray-800">
                        <a href="{{ url('/') }}">
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M16.5 4.5L4.5 16.5" stroke="#1F2937" stroke-width="2.3" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M4.5 4.5L16.5 16.5" stroke="#1F2937" stroke-width="2.3" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                        </a>
                    </div>
                        ...
                        <a href="{{ route('masterplans_post', 'id=' . $next_id) }}">
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                                ...
                                <g clip-path="url(#clip0_525_17010)">
                                    <path d="M7.5 16.5L13.5 10.5L7.5 4.5" stroke="#1F2937" stroke-width="2.3"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </g>
                                <defs>
                ...
                <div
                    ...
                    <div
                        ...
                        <a class="mx-2 text-base font-light cursor-pointer text-gray-400 duration-300 xl:mx-4 hover:text-black"
                            href="#urbanscape" @click="active = ac">&nbsp;Urbanscape</a>
                        <a class="mx-2 text-base font-light cursor-pointer text-gray-400 duration-300 xl:mx-4 hover:text-black"
                            href="#description" @click="active = sr">&nbsp;Description</a>
                        <a class="mx-2 text-base font-light cursor-pointer text-gray-400 duration-300 xl:mx-4 hover:text-black"
                            href="#map" @click="active = ex">&nbsp;Map</a>
                        <a class="mx-2 text-base font-light cursor-pointer text-gray-400 duration-300 xl:mx-4 hover:text-black"
                            href="#masterplans" @click="active = rs">&nbsp;Masterplans</a>
                        @if (!$streetscapes->isEmpty())
                            <a class="mx-2 text-base font-light cursor-pointer text-gray-400 duration-300 xl:mx-4 hover:text-black"
                                href="#sctreetcapes" @click="active = au">&nbsp;Streetscaps</a>
                        @endif
                        <a class="mx-2 text-base font-light cursor-pointer text-gray-400 duration-300 xl:mx-4 hover:text-black"
        ...
        <div class="">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 border-t ">
                        <div class="col-span-9" x-bind:class="{ 'col-span-12': !sideBar, 'col-span-9': sideBar }"
                            ...
                            <div class="relative flex items-center justify-center w-full py-10">
                                ...
                                <div class="">
                                    <img id="img"
                                        class="object-cover z-50 md:w-[561px] w-[200px] max-h-[512px] border saturate-120"
            ...
            <section id="description">
                <div class="flex flex-col items-center justify-center pt-8 border-t ">
                    ...
                    <div class="flex items-center flex-wrap z-10 md:w-[915px] justify-center px-8 py-8">
                        ...
                        @php
                            $image1 = $item->imageb ?? null;
                            $pieces = explode(', ', $image1);
                        @endphp

                        <div class="flex md:flex-row flex-col items-center justify-center gap-3 ">
            ...
            @if ($master)
                <section id="masterplans">
                    <div class="" x-data="{ swiper: null }">
                        <div class="flex items-center justify-center px-8 pt-8">
            ...
            {{-- sreetscapes section --}}
            @if (!$streetscapes->isEmpty())
                <section id="sctreetcapes">
                    <div class="border-t" x-data="{ swiper: null }" x-init="swiper = new Swiper('.swiper-st', {
                        loop: true,
                        slidesPerView: 1,
                        spaceBetween: 0,
                        ...
                        <div class="swiper-container swiper-st">
                            <div class=" my-8 swiper-wrapper h-[398px]">
                                ...
                                @foreach ($streetscapes as $street)
                                    <div
                                        class="overflow-hidden street-w transition border rounded-md shadow-sm swiper-slide">
            ...
            <section id="resources">
                <div class="border-t  pt-8 text-2xl font-semibold text-center text-gray-800">
                    Sources
                </div>
                    ...
                    <div class="swiper-container" x-ref="container">
                        <div class="flex items-center justify-center gap-4 my-8 swiper-wrapper">
                            @forelse ($urbanscapes as $urban)
                                <div
                                    class="relative bg-white swiper-slide h-[438px] max-w-[260px] overflow-hidden transition border rounded shadow-sm saturate-120 animate__animated animate__backInRight">

                                    <a href="urbanscapes_post?id={{ $urban->id }}"
                                        class="flex flex-col h-full duration-300">
                                        <img alt="Art"
                                            src="{{ asset('storage/uploads/thumbnails/urbanscapes/' . $urban->image) }}"alt=""
                                            class="object-cover saturate-120 h-[332px]" />
    ...
    <script>
        ...
        function initMap() {
            ...
            var map = new google.maps.Map(document.getElementById('urbanmap'), {
                center: location,
                zoom: 16
            });
