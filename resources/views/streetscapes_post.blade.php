                ...
                <div
                    ...
                    <div
                        ...
                        <a class="mx-2 text-base font-light cursor-pointer text-gray-400 duration-300 xl:mx-4 hover:text-black"
                            href="#streetscaps" @click="active = rs">&nbsp;Streetscaps</a>
                        ...
                        @if ($master)
                            <a class="mx-2 text-base font-light cursor-pointer text-gray-400 duration-300 xl:mx-4 hover:text-black"
                                href="#masterplan" @click="active = ac">&nbsp;Masterplan</a>
                        @endif

                        @if (!$urbanscapes->isEmpty())
                            <a class="mx-2 text-base font-light cursor-pointer text-gray-400 duration-300 xl:mx-4 hover:text-black"
                                href="#urbanscaps" @click="active = au">&nbsp;Urbanscaps</a>
                        @endif
            ...
            <section id="description">
                <div class="flex flex-col items-center justify-center pt-8 border-t ">
                    ...
                    <div class="flex items-center justify-center px-8 py-8">
                        ...
                        <ul
                            class="flex flex-col text-gray-800 w-[915px] flex-wrap justify-center items-start text-base list-none">
                            {!! $des !!}
                        </ul>
            ...
            <section class="bg-gray-100 border-t overflow-x-hidden">
                <div class="" x-data="{ swiper: null }" x-init="swiper = new Swiper($refs.container, {
                    ...
                    <div class="swiper-container" x-ref="container">
                        <div class=" my-8 swiper-wrapper flex justify-center gap-4 items-center">


                            @forelse ($streetscapes as $street)
                                <div
                                    class="overflow-hidden bg-white street-w  transition border rounded-md shadow-sm swiper-slide">
