                        ...
                        <div class="flex flex-col mx-auto">
                            <a href="">
                                ...
                                <p class="w-full pt-2 text-base font-bold text-center text-black bg-white border-t">
                                  {{ $item->name }}</p>
                                <p class="pb-2 text-xs text-center text-gray-800">{{ $item->type }}</p>
                            </a>
                        </div>
                    </div>
                @empty
        ...
        <div class="py-8">
            <div class="grid grid-cols-1 gap-5 row-gap-5 lg:grid-cols-4 xl:grid-cols-5 md:grid-cols-2">
                ...
                <div class="flex transition border shadow-md md:hover:scale-110">
                    <div class="flex flex-col mx-auto mb-16">
                        <a href="">
                            ...
                            <p class="w-full pt-2 text-base font-bold text-center text-black bg-white border-t">KWARTAŁ
                            </p>
                ...
                <div class="flex transition border shadow-md md:hover:scale-110">
                    <div class="flex flex-col mx-auto mb-16">
                        <a href="">
                            <img class="object-fill w-full h-full" src="./img/metropolis-1170x1641.jpg"
                                alt="content">
                            <p class="w-full pt-2 text-base font-bold text-center text-black bg-white border-t">
                                METROPOLIS</p>
                ...
                <div class="flex transition border shadow-md md:hover:scale-110">
                    <div class="flex flex-col mx-auto mb-16">
                        <a href="">
                            <img class="object-fill w-full h-full" src="./img/riba-journal-1170x1641.jpg"
                                alt="content">
                            <p class="w-full pt-2 text-base font-bold text-center text-black bg-white border-t">RIBA
                            </p>
                            <p class="pb-2 text-xs text-center text-gray-800">magazine</p>
                        </a>
                    </div>
                ...
                <div class="flex transition border shadow-md md:hover:scale-110">
                    <div class="flex flex-col mx-auto mb-16">
                        <a href="">
                            ...
                            <p class="w-full pt-2 text-base font-bold text-center text-black bg-white border-t ">PAISEA
                            </p>
                            <p class="pb-2 text-xs text-center text-gray-800">magazine</p>
                        </a>
                    </div>
                ...
                <div class="flex transition border shadow-md md:hover:scale-110">
                    <div class="flex flex-col mx-auto mb-16">
                        <a href="">
                            <img class="object-fill w-full h-full" src="./img/paysage-topscape-1170x1641.jpg"
                                alt="content">
                            <p class="w-full pt-2 text-base font-bold text-center text-black bg-white border-t">PAYSAGE
                                TOPSCAPE</p>
                            <p class="pb-2 text-xs text-center text-gray-800">magazine</p>
                        </a>
                    </div>
