<section class="mx-4 border-t border-b md:mx-16">
    <div class="block py-16 mx-4 md:mx-auto">
                ...
                <div>
                    <div class="juxtapose saturate-120">
                        ...
                        <img class="object-cover h-64 mb-6 rounded shadow-lg lg:h-96"
                            src="{{ asset('storage/uploads/thumbnails/streetscapes/' . $img0) }}"alt="00"
                            loading="lazy" onerror="this.src='{{ asset('storage/uploads/streetscapes/' . $img0) }}'" />
                        <img class="object-cover h-64 mb-6 rounded shadow-lg lg:h-96"
                            src="{{ asset('storage/uploads/thumbnails/streetscapes/' . $img1) }}"alt="00"
                            loading="lazy" onerror="this.src='{{ asset('storage/uploads/streetscapes/' . $img1) }}'" />
                    </div>
