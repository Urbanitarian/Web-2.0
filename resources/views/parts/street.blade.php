...
@endphp
        <div class="p-8 md:p-12 lg:px-12 lg:py-12">
            ...
            <fieldset class="flex flex-wrap justify-center gap-2 pt-8 mx-auto md:gap-4">
                 ...
                 <a href="{{ route('sfilter') }}?size=large">
                    <label for="large"
                ...
                <a href="{{ route('sfilter') }}?size=medium">
                    <label for="medium"
                 ...
                 <a href="{{ route('sfilter') }}?size=small">
                    <label for="small"
                    ...
                    <div class="mt-8 border-t border-b lg:w-1/4 lg:mt-0 lg:px-6">
                        <div>
                            ...
                            <p class="mt-2 text-center text-gray-600 "> &nbsp; {{ $streetscape->country }} </p>
                                ...
                                <button
                                  class="flex px-8 py-2 mx-auto my-4 text-base font-bold text-white uppercase bg-black border-0 rounded xl:mt-48 md:mt-8 focus:outline-none hover:bg-gray-800"> <a href="{{ $streetscape->link }}">See project </a></button>
