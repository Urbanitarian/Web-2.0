<section class="py-16 mx-4 mb-4 border-b md:mx-16">
    ...
    <div class="w-full">
        <h1 class="pb-8 text-3xl font-bold text-center text-gray-900 md:text-5xl">Web Resources</h1>
                        ...
                        <div class="flex flex-col mx-auto">
                            <a href="">
                                ...
                                <p class="w-full pt-2 text-base font-bold text-center text-black bg-white border-t">
                                  {{ $item->name }}</p>
                                <p class="pb-2 text-xs text-center text-gray-500">{{$item->type[0] ?? null; }}, {{   $item->type[1] ?? null }}</p>
                            </a>
                        </div>
                    </div>
                @empty
