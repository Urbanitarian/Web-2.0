...
@section('content')
 ...
 div.innerHTML += '<label class="block pt-2">Layer:</label><select name="Layer"class="h-4 px-2 text-xs font-bold rounded focus:outline-none"id="selectfilter" onchange="layer(this.value)"><option id="optionx" value="1" selected>MAP</option><option id="optionx" value="2" >OSM</option><option id="optionx" value="3">GEO</option><option id="optionx" value="4">TOPO</option><option id="optionx" value="5">CyclOSM</option></select>'
    return div;
    };
    legend.addTo(mymap);
        let count = 0;
