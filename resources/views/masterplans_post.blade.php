...
@section('main')
    <div data-barba="container" x-data="{ sideBar: true }">
        ...
        <div class="sticky top-0 z-10 bg-white">
            <div class="flex items-center justify-between md:flex-row flex-col gap-4 px-8 py-2 pt-2 border-b">
            ...
            <div class="flex items-center  justify-between px-8 py-3 shadow" x-data="{ active: 'ac' }">
                ...
                <div
                    ...
                    <div
                        class="flex flex-wrap justify-center pb-4 mx-auto mt-0 align-baseline flex-row md:space-y-0  md:pb-0">
                        <a class="link-scroll mx-2 text-base font-light cursor-pointer text-gray-400 duration-300 xl:mx-4 hover:text-black"
        ...
        <div class="">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 border-t ">
                        <div class="col-span-9" x-bind:class="{ 'col-span-12': !sideBar, 'col-span-9': sideBar }"
                            ...
                            <div class="relative flex items-center justify-center w-full py-10">
                                ...
                                <div class="">
                                    <img id="img"
                                        class="object-cover z-50 md:w-[536px] w-[200px]  max-h-[758px] border saturate-120"
                                ...
                                <div class="flex flex-col mt-6">
                                    ...
                                    <div class="flex flex-col w-full text-gray-700">
                                        ...
                                        <div class="flex items-center justify-between gap-3 py-1 border-b">
                                            ...
                                            <span class="text-xs text-gray-500 font-regular">{{ $item->popdensity }}<span
            ...
            @if (!$streetscapes->isEmpty())
                <section id="streetscaps">
                    <div class="" x-data="{ swiper: null }" x-init="swiper = new Swiper('.swiper-st', {
                        ...
                        <div class="flex items-center md:flex-row flex-col gap-2 justify-between px-8 pt-8">
                            <div class=""></div>
                            <div class="">
                        ...
                        <div class="swiper-container swiper-st">
                            <div class=" my-8 swiper-wrapper md:h-[398px] h-[230px]">


                                @forelse ($streetscapes as $street)
                                    <div class="overflow-hidden street-w transition border rounded-md shadow-sm swiper-slide"
                                        style="">
                                            ...
                                            <div class="flex flex-col h-full duration-300">
                                                ...
                                                <div class="juxtapose">
                                                    <img alt="Art"
                                                        ...
                                                        class="object-cover saturate-120 md:h-[480px] h-[700px]" />
                                                    <img alt="Art"
            ...
            {{-- urbanscpaes --}}
            @if (!$urbanscapes->isEmpty())
                <section id="urbanscaps">
                    <div class="border-t" x-data="{ swiper: null }" x-init="swiper = new Swiper('.swiper-ur', {
                        loop: true,
                        slidesPerView: 1,
                        spaceBetween: 0,
                                    ...
                                    <div
                                        ...
                                        <a href="urbanscapes_post?id={{ $urban->id }}"
                                            ...
                                            <div class="absolute bottom-1">
                                                ...
                                                <div
                                                    class="flex  items-center  justify-between px-2 text-sm text-gray-500">
                                                    <div class="">
            ...
            <section id="resources">
                <div class="border-t text-2xl pt-8 font-semibold text-center text-gray-800">
                    Sources
                </div>
