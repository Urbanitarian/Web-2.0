                        ...
                        <div class="grid grid-cols-12 border-t ">
                            <div class="col-span-9" x-bind:class="{'col-span-12': !sideBar, 'col-span-9': sideBar}"
                                ...
                                <div class="relative flex items-center justify-center w-full py-10">
                                    ...
                                    <div class="">
                                        <div class="juxtapose w-[970px] shadow-lg rounded" style="border-radius:3px;min-width:970px; min-height:480px;">
                                            <img id="img" class="h-full w-full object-cover z-30 h-[512px] border saturate-120"
        ...
        <div class="" x-data="{ swiper: null }" x-init="swiper = new Swiper('.swiper-mr', {
            ...
            <div class="swiper-container swiper-mr">
                <div class="my-8 swiper-wrapper">
                        <div class="overflow-hidden h-[442px] transition-all bg-white border rounded-md shadow swiper-slide  saturate-120 animate__animated animate__backInLeft">
                                ...
                                <div class="flex flex-col h-full duration-300">
                                    ...
                                    <div class="juxtapose" style="height: 360px;">
                                        <img alt="Art"
                                            ...
                                            class="object-cover saturate-120 h-full w-full max-h-[480px]" />
                                        <img alt="Art"
