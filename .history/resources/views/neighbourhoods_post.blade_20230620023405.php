...
@section('main')
            ...
            <div class="flex items-center justify-between px-8 py-2 pt-2 border-b">
                ...
                <div class="flex items-center justify-center gap-4">
                    <div class="" x-data="{ showDropDown: false }">
                        ...
                        <div x-show="showDropDown" id="" class="absolute z-50 top-16 right-12" style="display: none;">
            ...
            <div class="flex items-center justify-between px-8 py-3 shadow" x-data="{ active: 'ac' }">
                ...
                <div
                    ...
                    <div
                        ...
                        <a class="mx-2 text-base font-light cursor-pointer text-gray-400 duration-300 xl:mx-4 hover:text-black"
                            href="#masterplans"
                            @click="active = rs">&nbsp;Masterplans</a>
                        @if(!$streetscapes->isEmpty())
                        <a class="mx-2 text-base font-light cursor-pointer text-gray-400 duration-300 xl:mx-4 hover:text-black"
                            href="#sctreetcapes"
                            @click="active = au">&nbsp;Streetscaps</a>
                        @endif
                        <a class="mx-2 text-base font-light cursor-pointer text-gray-400 duration-300 xl:mx-4 hover:text-black"
                            href="#resources"
                ...
                <section id="urbanscape">
                    <div class="relative">
                        ...
                        <div class="grid grid-cols-12 border-t ">
                            <div class="" x-bind:class="{'col-span-12': !sideBar, 'col-span-9': sideBar}"
                                ...
                                <div class="relative flex items-center justify-center w-full py-10">
                                    ...
                                    <div class="">
                                        <img id="img"
                                            class="object-cover z-50 w-[561px] max-h-[512px] border saturate-120"
    ...
    <style>
        #description::before,#masterplans::before,#map::before,#streetscaps::before,#urbanscape::before,#resources::before {
            content: '';
            display: block;
            height: 129px;
            margin-top: -129px;
